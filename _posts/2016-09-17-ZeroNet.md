...
Imagine an internet without any censorship, with websites that'll never be taken down, where freedom of speech will hold true meaning. Where the government won't spy on you and social media giants won't objectify you
as a mindless consumer. Where you won't be bombarded with advertisements (carefully modelled according to your needs). Tamas Kocsis of Budapest did and the result is ZeroNet.
...
For a better and detailed explanation of what, why and how zeronet works, watch this [presentation](https://zeronet.io/files/ZeroNet_Presentation.pdf).
